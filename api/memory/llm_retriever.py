...
3. **主题一致** — 记忆所属的主题（theme KEY）与查询涉及的话题吻合。例如查询关于编程，优先留意 PROJECT（学业与创作产出）；查询关于偏好，留意 PREFERENCE（用户喜好）。
4. **时间线索** — 如果查询中出现了时间范围（如"最近""上周""7月"），优先匹配该时间段内的记忆。

## 处理规则

- 如果查询较为宽泛（如"项目""最近"），优先匹配近期记录。
...
查询要求："塔罗牌重构"
记忆库摘录：
  [0] (PROJECT) 塔罗牌工具是Sonetto项目的人文性质彩蛋，Miso正在重构。
  [1] (MOMENT) 2026年7月11日，Miso让Sonetto分析塔罗牌工具代码，识别出小阿尔卡纳粗糙、逆位缺失等重构点。
  [2] (PREFERENCE) Miso 喜欢夏天和猫。
  [3] (MOMENT) 2026年7月12日凌晨，Miso抽塔罗牌问期末考运势，得圣杯六（逆位）和死神（正位）。
相关条目：[0, 1, 3]
...
查询要求："期末复习范围"
记忆库摘录：
  [0] (PREFERENCE) Miso 最喜欢洛天依。
  [1] (PROJECT) 2026年7月5日，Miso将数学复习范围整理成md复习目录。
  [2] (MOMENT) 2026年7月6日，Miso考完了物理考试。
  [3] (PROJECT) 2026年7月7日，Miso将红线划定的数学复习范围整理成md复习目录。
相关条目：[2, 1, 3]
...
查询要求："喜欢看什么视频"
记忆库摘录：
  [0] (PREFERENCE) Miso 喜欢看日剧《孤独的美食家》。
  [1] (PROJECT) Miso学习前端知识，涉及TS泛型、JS箭头函数和Vue3的ref/computed。
  [2] (PREFERENCE) Miso 喜欢新海诚的电影。
  [3] (PROJECT) 塔罗牌工具正在重构中。
相关条目：[0, 2]
